...
@ListenerFor(sourceClass = ModenaMenu.class, systemEventClass = PostAddToViewEvent.class)
public class ModenaMenu extends AbstractMenu implements Widget, ComponentSystemEventListener {
