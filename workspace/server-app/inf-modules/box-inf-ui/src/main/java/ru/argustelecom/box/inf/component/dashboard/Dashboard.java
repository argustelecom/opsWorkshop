...
@ResourceDependencies({ 
		...
		@ResourceDependency(name = "inf/styles/box-components.css", target = "head") 
})//@formatter:on
public class Dashboard extends UIComponentBase {

	public static final String COMPONENT_TYPE = "ru.argustelecom.box.component.Dashboard";
	public static final String COMPONENT_FAMILY = "ru.argustelecom.box.component";
