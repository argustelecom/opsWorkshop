CREATE OR REPLACE FUNCTION datamart.get_customer_flow_of_funds(
...
BEGIN
  l_start_balance := system.get_customer_balance_before(a_customer_id, a_date_from);
  l_delta_balance := system.get_customer_balance_delta(a_customer_id, a_date_from, a_date_to);
