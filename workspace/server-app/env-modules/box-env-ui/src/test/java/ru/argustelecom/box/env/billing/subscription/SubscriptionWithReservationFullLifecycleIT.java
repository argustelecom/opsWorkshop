...
public class SubscriptionWithReservationFullLifecycleIT extends AbstractWebUITest implements LocationParameterProvider {

    public static class SubscriptionWithReservationFullLifecycleITSubParamsDonator implements ParamsDonator {
    ...
    public void shouldMoveSubscriptionToActivationWaiting(
            ...
            @DataProvider(
                    ...
                    donatorClass = SubscriptionWithReservationFullLifecycleITSubParamsDonator.class
