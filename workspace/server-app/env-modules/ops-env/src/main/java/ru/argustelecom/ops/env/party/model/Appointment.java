...
import ru.argustelecom.ops.inf.modelbase.BusinessDirectory;

/**
 * Класс описывающий должность, которую может занимать {@linkplain ru.argustelecom.ops.env.party.model.role.Employee
