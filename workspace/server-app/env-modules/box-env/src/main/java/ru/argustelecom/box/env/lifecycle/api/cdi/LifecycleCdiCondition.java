...
/**
 * Маркерный интерфейс {@linkplain LifecycleCondition проверяемого условия} жизненного цикла. Реализация интерфейса
 ...
 */
public interface LifecycleCdiCondition<S extends LifecycleState<S>, O extends LifecycleObject<S>>
		extends LifecycleCondition<S, O> {
}
