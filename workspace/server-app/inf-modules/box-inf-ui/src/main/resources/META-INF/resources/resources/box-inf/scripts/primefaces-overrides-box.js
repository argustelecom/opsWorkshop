...
$(function () {
    ...
    // Этот фикс для того, чтобы избежать плавающего поведения выпадающего меню для SelectOneMenu (BOX-254 и BOX-883) на странице и в диалоге.
    ...
    // Этот фикс для того, чтобы избежать плавающего поведения выпадающего меню SelectCheckboxMenu (BOX-254 и BOX-883) на странице и в диалоге (BOX-1208).
    PrimeFaces.widget.SelectCheckboxMenu.prototype.alignPanel = function () {
        ...
        if (this.panel.parent().attr('id') === this.id) {
            ...
            if (typeof this.filterInput != 'undefined' &&  this.filterInput != null) {
                // В этой ветке положение панели выпадающего меню SelectCheckboxMenu c атрибутом filter=true. Положение панели верхний левый угол поля (BOX-1208)
                this.panel.position({
                    my: 'left top'
                    , at: 'left top'
                    , of: this.jq
