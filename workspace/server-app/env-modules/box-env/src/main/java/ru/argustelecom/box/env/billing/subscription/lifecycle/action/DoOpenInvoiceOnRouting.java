...
@LifecycleBean
public class DoOpenInvoiceOnRouting implements LifecycleCdiAction<SubscriptionState, Subscription> {
	...
	public void execute(ExecutionCtx<SubscriptionState, ? extends Subscription> ctx) {
		...
		processor.openInvoiceOnRouting(subscription, toState, executionDate);
	}
}
