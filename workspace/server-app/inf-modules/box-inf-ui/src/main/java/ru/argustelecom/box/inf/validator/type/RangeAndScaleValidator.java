package ru.argustelecom.box.inf.validator.type;
...
import ru.argustelecom.box.inf.util.ParseUtils;

@FacesValidator("ru.argustelecom.box.inf.validator.type.RangeAndScaleValidator")
