...
public class SubscriptionWithoutReservationShortLifecycleIT extends AbstractWebUITest implements LocationParameterProvider {

    public static class SubscriptionWithoutReservationShortLifecycleITParamsDonator implements ParamsDonator {

        private static final long serialVersionUID = -1399327179134200778L;
        ...
        public void donate(TestRunContext testRunContext, String methodName) {
            ...
            switch (methodName) {
                ...
                case "shouldActivateSubscription": {
                    // нет резервирования, хватит копейки
                    balance = "00.01";
                    break;
                }
    ...
    public void shouldMoveSubscriptionToActivationWaiting(
            ...
            @DataProvider(
                    ...
                    donatorClass = SubscriptionWithoutReservationShortLifecycleITParamsDonator.class
